...
var _user$project$IconNonsense$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _debois$elm_mdl$Material_Icon$i, model.iconNames));
};
...
var _user$project$IconNonsense$Model = function (a) {
	return {iconNames: a};
};
...
var Elm = {};
Elm['IconNonsense'] = Elm['IconNonsense'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['IconNonsense'], 'IconNonsense', typeof _user$project$IconNonsense$main === 'undefined' ? null : _user$project$IconNonsense$main);
